...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        if qk_norm:  # Disable flash attn for qk_norm
    ...
    def forward(self, x: torch.Tensor, 
        ...
        if qkv.dtype == torch.float32 or (self.fused_attn and not self.flash_attn):
            ...
            if freqs_cis is not None:
                raise NotImplementedError("This does not align with the flash attn implementation.")
